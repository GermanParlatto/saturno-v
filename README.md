...
make test             # 147 tests, no AWS calls
...
147 tests, ~2s, no AWS calls and no network: `respx` intercepts HTTP, boto3 is stubbed.
...
tools/        catalog seeder, state reset, dataset generator, manual probe
```
